...
if MODE == "PROD":
    ...
    EVENT_TICKET_PANEL_CHANNEL_ID = 0  # TODO: channel where the Open-Ticket panel lives
    EVENT_TICKET_CATEGORY_ID = 0  # TODO: category the ticket channels are created in
    EVENT_TICKET_TRANSCRIPT_CHANNEL_ID = 0  # TODO: event transcript log channel
