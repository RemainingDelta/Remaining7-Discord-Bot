        ...
        sections=(
            ...
            PolicySection(
                ...
                body=(
                    ...
                    "- Ticket transcripts. When a support, tournament, or "
                    "event ticket is closed, the bot saves that ticket's "
                    "message history as a text file, along with copies of up "
        ...
        sections=(
            PolicySection(
                ...
                body=(
                    ...
                    "(such as a ticket transcript, or an image copied into "
                    "one, already shared with another user)."
                ),
            ),
            PolicySection(
